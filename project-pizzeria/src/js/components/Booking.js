  ...
  initTables(event){
    ...
    if(clickedTable && clickedTable.classList.contains(classNames.booking.table)){
      if(!clickedTable.classList.contains(classNames.booking.tableBooked)){
        const tableNumber = clickedTable.getAttribute('data-table');
        if(!thisBooking.array.choosedTables.includes(tableNumber)){
          selectTable(tableNumber);
        } else if (thisBooking.array.choosedTables.includes(tableNumber)){
          deselectTable();
        }
      } else if (clickedTable.classList.contains(classNames.booking.tableBooked)){
        alert('Stolik jest zajęty');
      }
      console.log(thisBooking.array.choosedTables);
    ...
    function deselectTable() {
      ...
      thisBooking.array.choosedTables = [];
    }

    function selectTable(tableNumber) {
      thisBooking.array.choosedTables = [tableNumber];
      for(let table of thisBooking.dom.tables){
