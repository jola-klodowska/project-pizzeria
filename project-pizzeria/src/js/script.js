...

{
  ...
  class CartProduct {
    ...
    getData() {
      ...
      dataSummary.id = thisCartProduct.id;
      dataSummary.amount = thisCartProduct.amount;
      dataSummary.price = thisCartProduct.price;
      dataSummary.priceSingle = thisCartProduct.priceSingle;
      dataSummary.name = thisCartProduct.name;
      dataSummary.params = thisCartProduct.params;
